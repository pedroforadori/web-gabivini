...
export default function About() {
    return (
        <div className="bg-white h-screen w-full items-center flex-col">
            ...
            <div className="flex justify-end items-center h-[80vh] max-sm:flex max-sm:flex-col-reverse
                            max-md:flex max-md:flex-col-reverse max-md:justify-center">
                <div className="relative left-40 
                                max-sm:left-0 max-sm:w-4/5 max-sm:my-10 max-sm:text-xl
                                max-md:left-0 max-md:w-1/2 
                                max-lg:w-1/3 max-lg:left-0
